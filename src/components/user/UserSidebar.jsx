...
const UserSidebar = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { name: 'AI Assistant', path: '/user/ai-assistant', icon: Wand2 },
    { name: 'My Recipes', path: '/user/recipes', icon: UtensilsCrossed },
    { name: 'Meal Planner', path: '/user/meal-planner', icon: CalendarDays },
